...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/requirement-gen/docs',

      name: 'RequirementGenDocs',

      component: () => import('../views/requirement-gen/RequirementDocList.vue'),

      meta: { requiresAuth: true },
    },

    {
      path: '/requirement-gen/tasks',

      name: 'RequirementGenTasks',

      component: () => import('../views/requirement-gen/GenTaskList.vue'),

      meta: { requiresAuth: true },
    },

    {
      path: '/requirement-gen/results',

      name: 'RequirementGenResults',

      component: () => import('../views/requirement-gen/GenResultViewPage.vue'),
